...
async function elementConnected(element) {
	...
	const data = { items: _addDBLClickHandlerToItems(JSON.parse(element.getAttribute("value")||"[]"), element.getAttribute("ondblclickHandler")), 
...
export const item_list = {trueWebComponentMode: true, elementConnected};
