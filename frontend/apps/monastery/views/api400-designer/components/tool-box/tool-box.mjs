...
export const tool_box = { trueWebComponentMode: true, elementConnected, removeElement };
monkshu_component.register( "tool-box", `${COMPONENT_PATH}/tool-box.html`, tool_box );
