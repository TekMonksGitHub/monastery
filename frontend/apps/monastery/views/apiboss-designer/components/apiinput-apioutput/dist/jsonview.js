  ...
  return (() => {
        ...
        function r(e, r) {
          for (var i = {}, a = [], s = 0; s < e.length; s++) {
            ...
            if (-1 !== u) n[u].references++, n[u].updater(f);
              ...
              var v = o(f, r);
              (r.byIndex = s),
                n.splice(s, 0, { identifier: p, updater: v, references: 1 });
            }
            a.push(p);
          }
          return a;
    ...
    return (
      (() => {
        ...
        function w(e) {
          e.isExpanded
            ? ((e.isExpanded = !1), k(e), b(e))
            : ((e.isExpanded = !0), S(e), E(e));
        }
        function L(e, n) {
          n(e),
            e.children.length > 0 &&
        ...
        function A(e, n) {
          ...
          L(e, function (e) {
            (e.el = (function (e) {
              ...
              return (
                null !== e.parent && r.classList.add(x),
                (r.style = "margin-left: " + 18 * e.depth + "px;"),
                r
              );
            })(e)),
              t.appendChild(e.el);
        ...
        function $(e) {
          L(e, function (n) {
            (n.isExpanded = !1),
              n.depth > e.depth && n.el.classList.add(x),
              k(n);
          });
        }
        function z(e) {
